/**
 *  NEO Coolcam SOS4 remote control v1.0.0
 *  (Model: NAS-RC03Z)
 *
 *  Author: 
 *    Volodymyr Stepanets (vstepanets)
 *
 *  Changelog:
 *
 *    1.0 (07/20/2019)
...
metadata {
	definition (
		name: "NEO Coolcam SOS4 remote control", 
		namespace: "MySmartThings", 
		author: "vstepanets",
		...
		fingerprint mfr:"0258", prod:"0003", model:"108A", deviceJoinName: "NEO SOS4"// NAS-RC03Z
